      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center relative z-10 pt-8 md:pt-12 pb-8 md:pb-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start gap-6 md:gap-8 pt-4 md:pt-0">
          ...
          <div className="flex flex-row gap-3 sm:gap-4">
            <Link href="https://play.google.com/store/apps/details?id=com.valarglobal.valarpay&hl=en" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-white text-black px-2 sm:px-4 lg:px-6 py-2.5 lg:py-3 rounded-[12px] hover:bg-gray-50 transition-all hover:scale-105 shadow-sm w-[145px] sm:w-[160px] lg:w-[180px]">
              <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 mr-1.5 sm:mr-2 lg:mr-3 shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col items-start leading-none shrink-0">
                <span className="text-[9px] sm:text-[10px] lg:text-[11px] text-gray-600 font-medium whitespace-nowrap">GET IT ON</span>
                <span className="text-[12px] sm:text-[14px] lg:text-[16px] font-bold whitespace-nowrap">Google Play</span>
              </div>
            </Link>
            
            <Link href="https://apps.apple.com/us/app/valarpay-local-global-bank/id6755668965" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-white text-black px-2 sm:px-4 lg:px-6 py-2.5 lg:py-3 rounded-[12px] hover:bg-gray-50 transition-all hover:scale-105 shadow-sm w-[145px] sm:w-[160px] lg:w-[180px]">
              <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 mr-1 sm:mr-2 lg:mr-2 shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col items-start leading-none shrink-0">
                <span className="text-[9px] sm:text-[10px] lg:text-[11px] text-gray-600 font-medium whitespace-nowrap">Download on the</span>
                <span className="text-[12px] sm:text-[14px] lg:text-[16px] font-bold whitespace-nowrap">App Store</span>
              </div>
            </Link>
          </div>
