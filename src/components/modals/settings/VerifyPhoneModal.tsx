...
const VerifyPhoneModal: React.FC<Props> = ({ isOpen, onClose, phone }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#0A0A0A] border border-white/10 rounded-2xl w-full max-w-md p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="text-white text-lg font-semibold">Verify Phone</h3>
            <p className="text-white/60 text-sm mt-1">Enter the code sent to {phone}</p>
          </div>
