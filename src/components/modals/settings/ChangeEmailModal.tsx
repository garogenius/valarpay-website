...
const ChangeEmailModal: React.FC<Props> = ({ isOpen, onClose, onSubmit }) => {
      ...
      <div className="relative bg-[#0A0A0A] border border-white/10 rounded-2xl w-full max-w-md p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-white/60 text-sm mt-1">Enter your new email address</p>
          </div>
        ...
        <label className="text-white/60 text-xs mb-2 block">New Email</label>
        <input
          value={email}
